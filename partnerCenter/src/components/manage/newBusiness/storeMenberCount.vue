		...
		<div class="bg-f mb-5">
			...
			<div class="fz12 fc-c line-type flex-box">
				<div class="item checkbox-box" v-for="checkbox in selectList">
					<input type="checkbox" :value="checkbox.val" :checked="select.indexOf(checkbox.val)>=0" @click="selectType(checkbox.val)"/>
...
//	    		/type : _self.type , //曲线分类
	    	...
	    	getData.getStoreMembeStatistics(_data).then(res=>{
	    		let _data = res.data ;
				if(_data.state == 1){
