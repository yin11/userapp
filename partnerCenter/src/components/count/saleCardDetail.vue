<template>
	<div>
		<!--标题栏-->
		<header class="bg-f fc-f" :style="'padding-top:'+status_bar_height+'px'">
		...
		<div class="bg-f">
			...
			<div class="list-con border-buttom fc-c fz12" v-else  v-for="item in list">
				...
				<div class="flex-box">
					<div class="item">
						<img src="@/assets/img/card2.png" width="80%" v-if="item.cardType ==0"/>
						<img src="@/assets/img/card1.png" width="85%" v-else-if="item.cardType ==1"/>
					</div>
					<div class="item">
...
export default {
	...
	mounted(){
    	let _self = this ;
    	comm.postColor('F7094D'); //传递顶部的手机导航栏的色值给安卓
